...
public class disable extends SubBase {
    ...
    public boolean onCommand(Player player, String[] args) {
        ...
        try {
            ...
            // ArenaStatusChangeEvents disablearena = new
            // ArenaStatusChangeEvents(pre, arena);
        ...
        player.sendMessage(tmp = SkyApi.getMessageManager().getAdminMessage("command.message.disabledSuccess").replace("%ID%", ar.getCurrent().toString()));
