...
/**
 * SuperSkyBros First Created 20/11/13
 *
 * @author Libaryaddit
 * @version 0.1
 */
public class PropertiesManager {
    ...
    public Object getPropertiesConfig(String name, Object obj) {
        try {
            ...
            if (obj instanceof String) return properties.getProperty(name, (String) obj);
            return obj;
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void removeArrows(Player player) {
        try {
            ...
            if (currentVersion.contains("v1_6_R2")) methodName = "m";
