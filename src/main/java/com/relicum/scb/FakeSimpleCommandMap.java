/**
 * This Code was wrritten and designed by
 */
...
/**
 * This code was written and designed by MylesC and is part of the PerWorldsPlugin Which can be found at
 * http://dev.bukkit.org/bukkit-mods/perworldplugins/ Full Credits belong to him. He has granted usage of this code
 * provided it is made aware he is the author as per https://github.com/MylesIsCool/PerWorldPlugins
 *
 * @author MylesC The type FakeSimpleCommandMap.
 */
    ...
    public boolean dispatch(CommandSender sender, String commandLine)
        ...
        try {
            if (target instanceof PluginIdentifiableCommand
                ...
                if (!SCB.p.checkWorld(t.getPlugin(), p.getWorld()) && !p.isOp()) {
                    p.sendMessage(SCB.p.blockedMessage
