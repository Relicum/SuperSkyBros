...
public class XStreamWriter {
     ...
     * 
     * 
     * public static boolean save(String filePath, worldSettings ws) { XStream
     * xs = new XStream(); FileOutputStream fileOutputStream =
     * XStreamWriter.getFos(filePath);
     * 
     * try { ObjectOutputStream oos =
     * xs.createObjectOutputStream(fileOutputStream); oos.writeObject(ws);
     * oos.flush(); oos.close(); fileOutputStream.close(); xs = null; } catch
     ...
     * 
     * if (!f.exists()) {
     * System.out.println("Writer is creating a new file with path " +
     ...
     * 
     * FileOutputStream fos = null; try { fos = new FileOutputStream(filePath);
     * 
