...
public class MessageManager {
	...
	/**
	 * This is used to get a standard message pre-formatted Pass it the message path and it returns a string which You send
	 * direct to the player. Handel's all errors automatically.
	 *
	 * @param s String
	 * @return String
	 */
	...
	/**
	 * This is used to get a admin when admin commands are run it is pre-formatted Pass it the message path and it returns
	 * a string which You send direct to the player. Handel's all errors automatically.
	 *
	 * @param s String
	 * @return String
	 */
